...
This is an implementation of a vectorscope, using allegro5, and reading data from pulse audio by shelling out to `pacat`

## Demo

Attached video is of [SmarterEveryDay's Oscilloscope Music video](https://www.youtube.com/watch?v=4gibcRfp4zA)
